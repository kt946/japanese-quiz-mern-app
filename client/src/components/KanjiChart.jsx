  ...
  return (
    <section id="kanjiChart">
      ...
      <div className="flex flex-col gap-4">
        <div className="lesson-container-style bg-gradient-to-r from-blue-600 to-blue-500">
          <KanjiLesson data={kanjiData.lesson3} />
          <div className="banner-bg-style bg-curtain" />
        </div>

        <div className="lesson-container-style bg-gradient-to-r from-orange-600 to-orange-500">
          <KanjiLesson data={kanjiData.lesson4} />
          <div className="banner-bg-style bg-circles" />
        </div>

        <div className="lesson-container-style bg-gradient-to-r from-lime-600 to-lime-400">
