  ...
  return (
    <section id="kanjiChart">
      ...
      <div className="flex flex-col gap-4">
        <div className="relative bg-gradient-to-r from-blue-600 to-blue-500 rounded-xl overflow-hidden">
          <KanjiLesson data={kanjiData.lesson3} />
          <div className="banner-bg-style bg-curtain" />
        </div>

        <div className="relative bg-gradient-to-r from-orange-600 to-orange-500 rounded-xl overflow-hidden">
